                    ...
                    <div class="container">
                        <div class="row">
                            ...
                            <div class="mt-4 innercont p-5 me-4">
                                ...
                                <?php echo form_open_multipart('login/addProductSubmit') ?>
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="submit" class="btn btn-primary px-4" value="Add Product"></input>
                                        </div>
                                    </div>
                            ...
                            <div class="mt-4 innercont p-5 me-4">
                                ...
                                <div class="container">
                                    <div class="row">
                                        ...
                                        <?php } else { ?>
                                            <div class="alert alert-danger">No products have been created yet</div>
                                        <?php } ?>
