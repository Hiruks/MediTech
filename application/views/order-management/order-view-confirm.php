                ...
                <div class="dynamic-page container m-2">
                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <h2 class="mb-5">Confirm Order Payment</h2>


                            <?php echo form_open_multipart('login/orderUpdateSubmit') ?>
                                <div class="row">
                                <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label>Recipt / Cheque Image</label>
                                            <input type="file" name="userfile" class="form-control" placeholder="Enter customer email address" size="20" required>
                                            <input type="text" name="id" class="form-control invisible d-none" value="<?php echo $orders[0]->id; ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group mb-4">
                                            <label>Recipt / Cheque No.</label>
                                            <input type="text" name="recipt" class="form-control" placeholder="Enter reciept / cheque no.">
                                        </div>
                                    </div>

                                    <div class="col-md-12">
                                        <div class="form-group">
                                        <input type="submit" class="btn btn-success shadow-md me-6"></input>
                                        </div>
                                    </div>
